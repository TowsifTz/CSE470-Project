<?php 
	include("../controller/employeeID.php")
?>

<html>
<head>
	<title>Apply Leave | Employee Panel | Pixelated Ltd.</title>
	<link rel="stylesheet" type="text/css" href="styleapply.css">
</head>
<body style = "background: url(../assets/bg1.jpg);
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="../Model/applyleaveprocess.php?id=<?php echo $id?>" method="POST">
	...
	<table>
			...
			<?php
                include("../controller/applyleave.php")?>
